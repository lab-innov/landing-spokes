...
| --- | --- | --- |
| Hub/VPN/DNS | IDs existentes, peering spoke → hub, DINE sin zonas locales | Mismo reparto de responsabilidades; plataforma completa retorno y resolución |
...
| Auditoría | Diagnósticos a LAW/Event Hub corporativos, App Insights privado y AMPLS verificado | Misma separación entre diagnósticos, Activity Logs, alertas Defender y recepción SIEM |
...
- DINE debe cubrir los endpoints de los servicios; plataforma debe publicar por separado dominio interno ACA y nombre web. Requiere AMPLS corporativo y certificado TLS en Key Vault.
