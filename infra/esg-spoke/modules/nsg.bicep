...
var lists = { dns: dnsServers, clients: apiClientPrefixes, operators: operatorPrefixes, monitor: monitorPrefixes, cosmos: cosmosPrivateIps, function: functionPrivateIps }
