...
module cosmos './cosmos-db.bicep' = {
  name: 'cosmos-mop'
  params: { location: location, tags: tags, accountName: cosmosName, databaseName: 'premop-db', logAnalyticsWorkspaceResourceId: workspaceId, siemAuthorizationRuleId: siemAuthorizationRuleId, siemEventHubName: siemEventHubName }
}
