...
param sharedSyntheticStorageResourceId string
...
resource workloadStorageManagedPrivateEndpoint 'Microsoft.DataFactory/factories/managedVirtualNetworks/managedPrivateEndpoints@2018-06-01' = {
  name: 'ifiscaf-storage-blob'
  parent: managedVnet
  properties: {
...
resource sharedStorageManagedPrivateEndpoint 'Microsoft.DataFactory/factories/managedVirtualNetworks/managedPrivateEndpoints@2018-06-01' = {
  name: 'shared-synthetic-storage-blob'
  parent: managedVnet
  properties: {
    privateLinkResourceId: sharedSyntheticStorageResourceId
    groupId: 'blob'
  }
}
