...
Crea una Function Python con Durable, plan B1, dos Storage separados, Cosmos DB, OpenAI, Document Intelligence, Key Vault, App Insights y una VNet `/24` con endpoints privados y NSG. Consume VPN/hub, rutas, DNS/DINE, Log Analytics y AMPLS corporativos.
