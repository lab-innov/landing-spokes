...
Crea Function Python 3.13/P1v3, dos Storage, Cosmos NoSQL, OpenAI, Document Intelligence, Data Factory, App Insights y una VNet `/24` con NSG y endpoints privados. Reutiliza hub/VPN, rutas, DNS/DINE, Log Analytics y AMPLS corporativos. Databricks es una dependencia explícita pendiente de confirmar; no se crea ni modifica otro workspace.
